...
export interface FacilityRecord {
  ...
  subcenter?: string; // U-WIN sub-center/session-site-wise modes only
  sessionsite?: string; // U-WIN session-site-wise mode only
}

export type AnalysisMode = 'facility' | 'subcenter' | 'sessionsite';
...
export interface FilterState {
  ...
  activeGroup: string;
  analysisMode: AnalysisMode; // U-WIN only; HMIS always 'facility'
}
